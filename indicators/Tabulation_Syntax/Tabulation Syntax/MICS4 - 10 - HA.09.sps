...
* variable labels condom "Pourcentage de femmes âgées de 15-49 ans qui ont eu plus d'un partenaire sexuel " + 
...
* value labels tcondom 1 "Nombre de femmes âgées de 15-49 ans qui ont eu plus d'un partenaire sexuel au cours des 12 derniers mois".
...
*	ctables
  ...
  /title title=
   "Tableau HA.9: Rapports sexuels avec plusieurs partenaires"
  	"Pourcentage de femmes âgées de 15-49 ans qui ont déjà eu des rapports sexuels, pourcentage de celles ayant eu des " + 
