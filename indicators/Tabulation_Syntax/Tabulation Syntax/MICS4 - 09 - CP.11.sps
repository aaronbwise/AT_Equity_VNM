...
value labels layer 0 "Percentage of women age 15-49 years who believe a husband is justified in beating his wife/partner:".
...
* value labels total 1 "Nombre de femmes �g�es de 15-49 ans".
* variable labels goesout "Si elle sort sans le lui dire".
* variable labels neglects "Si elle n�glige les enfants".
...
* variable labels burns "Si elle br�le la nourriture".
* variable labels any "Pour toutes ces raisons[1]".
* value labels layer 0 "Pourcentage de femmes �g�es de 15-49 ans qui croient qu'il est justifi� qu'un mari batte sa femme/partenaire:".

* Ctables command in English (currently active, comment it out if using different language).
ctables
  /vlabels variables = layer total
           display = none
  /table hh7 [c] + hh6 [c] + wage [c] + mstatus [c] + welevel [c] + windex5 [c] + ethnicity [c] + tot1 [c]  by 
  ...
  "Table CP.11: Attitudes toward domestic violence"
  	"Percentage of women age 15-49 years who believe a husband is justified in beating his wife/partner in various circumstances, " + surveyname
  caption=
...
ctables
  ...
  "Tableau CP.11: Attitudes vis-�-vis de la violence domestique"
  	"Pourcentage de femmes �g�es de 15-49 ans qui croient qu'il est justifi� qu'un mari batte sa femme dans diff�rentes situations, " + surveyname
  caption=
