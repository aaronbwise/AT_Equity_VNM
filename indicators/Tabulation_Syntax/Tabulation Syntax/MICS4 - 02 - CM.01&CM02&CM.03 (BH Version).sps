...
* Main program - calls.
*   MICS4 - 02 - mort_d.sps  for calculation of deaths.
*   MICS4 - 02 - mort_E.sps  for calculation of exposure.
*   MICS4 - 02 - mort_c.sps  for calculation of probabilities and rates, and final tables.
...
include 'MICS4 - 02 - mort_D.sps'.	
include 'MICS4 - 02 - mort_E.sps'.		 
include 'MICS4 - 02 - mort_C.sps'.		 
