...
* ctables
  ...
  /slabels position = column visible = no
  /title title=
   "Tableau HA.4M: Attitudes bienveillantes à l'égard des gens vivant avec le VIH/SIDA"
	  "Pourcentage de hommes âgées de 15-49 ans qui ont entendu parler du SIDA et expriment une attitude bienveillante à l'égard des gens vivant avec le VIH/SIDA, " + surveyname
  caption = 
