...
value labels total 1 "Number of men age 15-24".
 ...
 * value labels total 1 "Nombre de hommes âgées 15-24 ans".
...
ctables
  ...
  /table hh7 [c] + mage [c] + mmstatus [c] + mnelevel [c] + windex5 [c] + ethnicity [c] + tot [c] by 
  ...
  /title title=
   "Table HA.2M: Knowledge about HIV transmission, misconceptions about HIV/AIDS, and comprehensive knowledge about HIV transmission"
  	"Percentage of young men age 15-24 years who know the main ways of preventing HIV transmission, percentage who know that a " +
...
* ctables
  ...
  /slabels position = column visible = no
  /title title=
   "Tableau HA.2M: Connaissance de la transmission du VIH, fausses idées à propos du VIH/SIDA, et connaissance approfondie de la transmission du VIH"
   "Pourcentage de hommes âgées de 15-24 ans connaissant les principaux moyens de prévenir la transmission du VIH, " + 
