...
report 
  ...
  /title = "MICS4 " "Listing of inconsistencies between cases reported " "at household level and within the women's, men's and children's files"
...
report 
  /format = automatic list
  /title = "MICS4 " "Listing of inconsistencies between COMPLETED cases reported " "at household level and within the women's, men's and children's files"
  /footnote = "Inconsistency information also saved in BAD.SAV"
  /variables = HH13  totcwoman "# completed in" "Woman" "file" HH13B totcman "# completed in" "Man" "file" HH15  totkid "# completed in" "child" "file"
  /break = HH1 HH2 'Cluster' 'Household'.
