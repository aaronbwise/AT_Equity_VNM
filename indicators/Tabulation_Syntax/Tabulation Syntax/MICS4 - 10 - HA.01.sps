...
recode wage (1, 2 = 1) (3 = 2) (4, 5 = 3) (6, 7 = 4).
variable labels wage "Age".
value labels wage 1 "15-24" 2 "25-29" 3 "30-39" 4 "40-49".
...
ctables
  ...
  /title title=
   ...
   "Percentage of women age 15-49 years who know the main ways of preventing HIV transmission, percentage who know that a " +
...
* ctables
  ...
  /slabels position = column visible = no
  /title title=
   "Tableau HA.1: Connaissance de la transmission du VIH, fausses idées à propos du VIH/SIDA, et connaissance approfondie de la transmission du VIH"
   "Pourcentage de femmes âgées de 15-49 ans connaissant les principaux moyens de prévenir la transmission du VIH, " + 
