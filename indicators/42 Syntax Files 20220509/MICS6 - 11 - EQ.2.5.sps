...
value labels layer1 0 "Percentage of household members living in households receiving specific types of support in the last 3 months:".

compute nhh = 1.
variable labels  nhh "Number of household members".
value labels nhh 1 " ".
...
ctables
  ...
  /titles title = 
    "Table EQ.2.5: Coverage of social transfers and benefits: All household members"
    "Percentage of household members living in households that received social transfers or benefits in the last 3 months, by type of transfers and benefits, " + surveyname
  caption = "[1] MICS indicator EQ.3 - Population covered by social transfers; SDG indicator 1.3.1".
.
