...
(MTA1=2 or (MTA1=2 and MTA2=00)) and MTA6=2 and MTA10=2

** Patterns of use of tobacco products are defined as follows:
Cigarettes:
Ever users: MTA2>00 and MTA2<98
Users at any time during the last one month: (MTA4>00 and MTA4<98) or (MTA5>00 and MTA5<98)
Other smoked tobacco products:
Ever users: MTA6=1
Users at any time during the last one month: MTA9>00 and MTA9<98
Smokeless tobacco products:
Ever users: MTA10=1
Users at any time during the last one month: MTA13>00 and MTA13<98
...
*MICS indicator SR.14b, Percentage of men who did not use any smoked tobacco product in the last month: (MTA1=2 or (MTA1=1 and MTA2=00) or MTA3=2 or (MTA4=00 and MTA5=00)) AND (MTA6=2 or MTA7=2).
compute mnone = 0.
if ((MTA1 = 2 or (MTA1 = 1 and MTA2 = 00) or MTA3 = 2 or (MTA4 = 00 and MTA5 = 00)) AND (MTA6 = 2 or MTA7 = 2)) mnone = 100.
variable labels mnone "Percentage of men who did not use any smoked tobacco product in the last month [2]".
...
ctables
  ...
  /titles title=
    "Table SR.10.1M: Current and ever use of tobacco (men)"
    "Percentage of men age 15-49 years who never used any tobacco product, percentage who ever used and currently use, by product, and percentage who currently do not use a smoked tobacco product, " + surveyname
   caption =
