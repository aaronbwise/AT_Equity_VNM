...
variable labels satisfM "Modern methods [1]".
value labels totneed 1 "Number of women currently married or in union with need for family planning".
compute lay1 = 0.
compute lay2 = 0.
compute lay3 = 0.
compute lay4 = 0.
...
ctables
  ...
  /titles title=
    "Table TM.3.3: Need and demand for family planning (currently married/in union)"
  		"Percentage of women age 15-49 years who are currently married or in union with unmet and met need for family planning, " +
