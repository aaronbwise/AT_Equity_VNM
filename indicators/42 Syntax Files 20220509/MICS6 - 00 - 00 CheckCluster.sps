...
ctables
  ...
  /categories var=all empty=exclude missing=exclude
  /slabels position=column
  /titles title='Childrens (under 5) region and type of place of residence by cluster'.

new file.

** TABLE TO CHECK CHILDREN'S (5-17) CLUSTERS **.
get file ='fs.sav'.
...
ctables
  ...
  /categories var=all empty=exclude missing=exclude
  /slabels position=column
  /titles title='Childrens (5-17) region and type of place of residence by cluster'.
