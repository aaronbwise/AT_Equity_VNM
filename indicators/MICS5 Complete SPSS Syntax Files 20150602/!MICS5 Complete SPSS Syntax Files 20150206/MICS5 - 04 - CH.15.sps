...
recode HH11  (8 thru hi = 8) (else = copy) into Nhhmem.
...
ctables
  ...
  /categories var = itnN total = yes position = after label = "Total"
  /categories var=all empty=exclude missing=exclude
  /slabels position=column visible = no
  /titles title=
	"Table CH.15: Access to an insecticide treated net (ITN) - number of household members"
