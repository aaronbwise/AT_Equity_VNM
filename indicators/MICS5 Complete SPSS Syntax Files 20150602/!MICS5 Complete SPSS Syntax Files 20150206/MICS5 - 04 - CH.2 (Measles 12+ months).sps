...
+ recode novacc (1,2 = 100) (3 = 0) into no1_r.

+ recode hasvcard (1 = 100) (2 = 0) into card1_r.
...
+ recode novacc (1,2 = 100) (3 = 0) into no2_r.

+ recode hasvcard (1 = 100) (2 = 0) into card2_r.
...
variable labels measles_r "".
variable labels no1_r "".
variable labels no2_r "".
variable labels all_r "".
variable labels card1_r "".
variable labels card2_r "".
...
ctables
   /vlabels variables = tot bcg_r polio0_r polio1_r polio2_r polio3_r dpt1_r dpt2_r dpt3_r yf_r measles_r 
	hepb0_r hepb1_r hepb2_r hepb3_r hib1_r hib2_r hib3_r no1_r no2_r all_r card1_r card2_r layer1 layer2
         display = none
  /table  tot [c] + hl4 [c] + hh7 [c] + hh6 [c] + melevel [c]  + windex5 [c] + ethnicity [c] by
  layer1 [c] >
   (bcg_r [s] [mean,'BCG',f5.1] + 
   polio0_r [s] [mean,'Polio 1',f5.1] + polio1_r [s] [mean,'Polio 1',f5.1] + polio2_r [s] [mean,'Polio 2',f5.1] + polio3_r [s] [mean,'Polio 3',f5.1] +
   dpt1_r [s] [mean,'DPT 1',f5.1] + dpt2_r [s] [mean,'DPT 2',f5.1] + dpt3_r [s] [mean,'DPT 3',f5.1]+
   hepb0_r [s] [mean,'HepB 1',f5.1] + hepb1_r [s] [mean,'HepB 1',f5.1] + hepb2_r [s] [mean,'HepB 2',f5.1] + hepb3_r [s] [mean,'HepB 3',f5.1] + 
   hib1_r [s] [mean,'Hib 1',f5.1] + hib2_r [s] [mean,'Hib 2',f5.1] + hib3_r [s] [mean,'Hib 3',f5.1] + 
   yf_r [s] [mean,'Yellow fever',f5.1] + no1_r [s] [mean,'None',f5.1]) +
   card1_r [s] [mean,'Percentage with vaccination card seen',f5.1,validn,'Number of children age 12-23 months',f5.0] +
  layer2 [c] > 
   (measles_r [s] [mean,'Measles',f5.1] +  all_r [s] [mean,'Full [a]',f5.1] + no2_r [s] [mean,'None',f5.1]) +
   card2_r [s] [mean,'Percentage with vaccination card seen',f5.1,validn,'Number of children age 24-35 months',f5.0]
