...
compute cigar15 = 0.
if (MTA2 > 00 and MTA2 < 15) cigar15 = 100.
variable labels cigar15 "Percentage of men who smoked a whole cigarette before age 15 [1]".
...
variable labels totSmoke "Number of men age 15-49 years who are current cigarette smokers".
...
ctables
  ...
  /title title=
     "Table TA.2M: Age at first use of cigarettes and frequency of use (men)"
   ...
   caption =
     "[1] MICS indicator 12.2 - Smoking before age 15 [M]"
  .
